! function(e) {
    ...
    e('.navbar-sidenav [data-toggle="tooltip"]').tooltip({
        ...
        o.preventDefault(), e("body").toggleClass("sidenav-toggled"), toggleCookie(), e(".navbar-sidenav .nav-link-collapse").addClass("collapsed"), e(".navbar-sidenav .sidenav-second-level, .navbar-sidenav .sidenav-third-level").removeClass("show")
    }), e(".navbar-sidenav .nav-link-collapse").click(function(o) {
        document.cookie = "new=1", o.preventDefault(), e("body").removeClass("sidenav-toggled")
...
window.toggleCookie = function() {

	var number = parseInt(Cookies.get('sidebar'));
	if (isNaN(number)) {
		number = 0;
	}
	else {
    ...
    Cookies.set('sidebar', number, { expires: 365 });
