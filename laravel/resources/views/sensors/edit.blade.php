            ...
            <div class="card-body">
              <form method="POST" action="/sensors/{{$sensor->id}}">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control {{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" placeholder="Enter name" name="name" value="{{ old('name', $sensor->name) }}" required autofocus>
                  @if ($errors->has('name'))
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-xl-7">
                    <input type="number" step="0.1" class="form-control {{ $errors->has('min') ? ' is-invalid' : '' }}" id="min" placeholder="Min temperature notify" name="min" value="{{ old('min', $sensor->min) }}">
                    @if ($errors->has('min'))
                      <span class="invalid-feedback">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-12 col-xl-7">
                    <input type="number" step="0.1" class="form-control {{ $errors->has('max') ? ' is-invalid' : '' }}" id="max" placeholder="Max temperature notify" name="max" value="{{ old('max', $sensor->max) }}">
                    @if ($errors->has('max'))
                      <span class="invalid-feedback">
                ...
                <div class="form-group text-center">  
                  <button type="submit" class="btn btn-primary">Edit Sensor</button>
                </div>
